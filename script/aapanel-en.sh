#! /bin/bash
# By Aaron
# https://github.com/MetaQuest/aaPanel_tool
...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://ghproxy.com/https://github.com/MetaQuest/aaPanel_tool/releases/download/1.0/LinuxPanel_EN-6.8.23.zip"
red "Download complete, downgrading."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://ghproxy.com/https://raw.githubusercontent.com/MetaQuest/aaPanel_tool/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://ghproxy.com/https://github.com/MetaQuest/aaPanel_tool/releases/download/1.3/LinuxPanel-7.7.0.zip"
...
function start_menu(){
    ...
    purple " https://github.com/MetaQuest/aaPanel_tool"
    yellow " ————————————————————————————————————————————————"
