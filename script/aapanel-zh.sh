...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://github.com/MetaQuest/aaPanel_tool/releases/download/1.0/LinuxPanel_EN-6.8.23.zip"
red "下载完成,正在降级."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://raw.githubusercontent.com/MetaQuest/aaPanel_tool/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://github.com/MetaQuest/aaPanel_tool/releases/download/1.3/LinuxPanel-7.7.0.zip"
blue "下载完成,正在降级."
