...
function English(){
wget https://raw.githubusercontent.com/MetaQuest/aaPanel_tool/main/script/aapanel-en.sh  -O aapanel-en.sh && chmod +x aapanel-en.sh && clear && ./aapanel-en.sh
}
...
function start_menu(){
    ...
    purple " GitHub：https://github.com/MetaQuest/aaPanel_tool"
    yellow " ————————————————————————————————————————————————"
    green " 1. English"
    green " 2. 简体中文"
    yellow " ————————————————————————————————————————————————"
